...
const AGENT_STORAGE_KEY = "auto-tobe:chat:selectedAgentId";
const SESSION_STORAGE_KEY = "auto-tobe:chat:activeSessionId";
/** Drafts are stored as one JSON blob per workspace: { [sessionId]: text }. */
const DRAFTS_KEY = "auto-tobe:chat:drafts";
/** Placeholder sessionId for a chat that hasn't been created yet. */
export const DRAFT_NEW_SESSION = "__new__";
const CHAT_WIDTH_KEY = "auto-tobe:chat:width";
const CHAT_HEIGHT_KEY = "auto-tobe:chat:height";
const CHAT_EXPANDED_KEY = "auto-tobe:chat:expanded";
/** Focus mode is a personal preference — global across workspaces/sessions. */
const FOCUS_MODE_KEY = "auto-tobe:chat:focusMode";
/**
 ...
 */
const OPEN_KEY = "auto-tobe:chat:isOpen";
