 ...
 *
 * Uses exact hostname match against `cdnDomain` (e.g. "atb-static.copilothub.ai"),
 ...
 * @param cdnDomain CDN hostname for legacy link detection (e.g. "atb-static.copilothub.ai")
 */
