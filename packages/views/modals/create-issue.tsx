...
import type { Issue, IssueStatus, IssuePriority, IssueAssigneeType } from "@atb/core/types";
import {
  DialogContent,
  DialogTitle,
...
import { useQuickCreateStore } from "@atb/core/issues/stores/quick-create-store";
import { issueDetailOptions } from "@atb/core/issues/queries";
import { useCreateIssue, useUpdateIssue } from "@atb/core/issues/mutations";
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const shouldShowBacklogHint =
        ...
        localStorage.getItem("auto-tobe:backlog-agent-hint-dismissed") !== "true";
        ...
        {backlogHintIssueId ? (
          <BacklogAgentHintContent
            ...
            onDismissPermanently={() => {
              localStorage.setItem("auto-tobe:backlog-agent-hint-dismissed", "true");
            }}
            onMoveToTodo={() => {
...
import { Dialog as DialogRoot } from "@atb/ui/components/ui/dialog";
