...
import { SubmitButton } from "@atb/ui/components/common/submit-button";
import { useChatStore, DRAFT_NEW_SESSION } from "@atb/core/chat";
import { createLogger } from "@atb/core/logger";
import { enterKey, formatShortcut, modKey } from "@atb/core/platform";
import type { UploadResult } from "@atb/core/hooks/use-file-upload";
...
export function ChatInput({
  ...
  const handleSend = () => {
    ...
    // session, not the message — the agent then can't `auto-tobe attachment
