...
import type { Issue } from "@atb/core/types";
...
// Mock @atb/views/navigation (AppLink + useNavigation)
vi.mock("../../navigation", () => ({
...
vi.mock("@atb/core/issues/stores/view-store", () => ({
...
vi.mock("@atb/core/issues/stores/view-store-context", () => ({
...
vi.mock("@atb/core/issues/stores/issues-scope-store", () => ({
...
vi.mock("@atb/core/issues/stores/selection-store", () => ({
...
vi.mock("@atb/core/issues/stores/recent-issues-store", () => ({
