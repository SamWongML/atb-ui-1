...
import { isGlobalPath } from "@atb/core/paths";
...
/**
 * Open a link — internal paths dispatch auto-tobe:navigate, external open new tab.
 *
...
export function openLink(href: string, currentSlug?: string | null): void {
  if (href.startsWith("/")) {
    ...
    window.dispatchEvent(
      new CustomEvent("auto-tobe:navigate", { detail: { path } }),
    );
  } else {
