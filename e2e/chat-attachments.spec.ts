 ...
 * The UI wiring is covered by `chat-input.test.tsx` in @atb/views; this
...
const DATABASE_URL =
  process.env.DATABASE_URL ?? "postgres://auto-tobe:auto-tobe@localhost:5432/auto-tobe?sslmode=disable";
