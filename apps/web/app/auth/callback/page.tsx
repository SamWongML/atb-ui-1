...
import { paths, resolvePostAuthDestination } from "@atb/core/paths";
    ...
    if (isDesktop) {
      ...
      loginWithGoogle(code, redirectUri)
        .then(async (loggedInUser) => {
          ...
          //    login on app.auto-tobe.ai instead of clicking the email link,
      ...
      <div className="flex min-h-screen items-center justify-center">
        <Card className="w-full max-w-sm">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">Opening auto-tobe</CardTitle>
            <CardDescription>
              You should see a prompt to open the auto-tobe desktop app. If
